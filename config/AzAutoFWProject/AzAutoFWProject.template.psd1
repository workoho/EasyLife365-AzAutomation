@{
    ...
    PrivateData   = @{
        ...
        AutomationRuntimeEnvironment = @{
            ...
            'EL365-AzAuto-V1' = @{
                Description = 'Runtime environment for EasyLife 365 Automation Runbooks with Az 11.2.0 and additional modules.'
                Runtime     = @{
                    Language = 'PowerShell'
                ...
                Packages    = @(
                    @{
                        ...
                        Name      = 'Az'
                        Version   = '11.2.0'     # Note that version 11.2.0 currently does not work correctly in PowerShell 5.1 in Azure Automation
                        IsDefault = $true
                    }
                    @{
                        Name    = 'Microsoft.Graph.Authentication'
